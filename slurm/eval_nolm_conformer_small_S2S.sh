#!/bin/bash
#SBATCH --job-name=eval_conformer_S_nolm
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/eval_conformer_S_nolm-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/eval_conformer_S_nolm-%j.err
...
echo "============================================================"
echo "conformer_small S2S — eval without LM — 2x A6000"
echo "============================================================"
