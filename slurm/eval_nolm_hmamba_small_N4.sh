#!/bin/bash
#SBATCH --job-name=eval_hmamba_S_N4_nolm
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/eval_hmamba_S_N4_nolm-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/eval_hmamba_S_N4_nolm-%j.err
...
echo "============================================================"
echo "H-Mamba Small N4 — eval without LM — 1x A6000"
echo "============================================================"
