...
echo "============================================================"
echo "H-Mamba Large N4 — 2x A6000, preempt"
echo "============================================================"
...
torchrun --nproc_per_node=2 --master_port=$MASTER_PORT train_s2s_hmamba.py hparams/S2S/hmamba_large_N4.yaml \
    --data_folder /data/user_data/anshulk/hnet_asr/LibriSpeech \
    --output_folder /data/user_data/anshulk/hnet_asr/results/hmamba_large_N4 \
    --batch_size 16 \
...
if [ $TRAIN_EXIT -eq 0 ]; then
    ...
    python train_s2s_hmamba.py hparams/S2S/hmamba_large_N4.yaml \
        --data_folder /data/user_data/anshulk/hnet_asr/LibriSpeech \
        --output_folder /data/user_data/anshulk/hnet_asr/results/hmamba_large_N4 \
        --batch_size 16 \
        --max_batch_length_train 600 \
