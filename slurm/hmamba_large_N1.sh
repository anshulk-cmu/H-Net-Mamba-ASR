#!/bin/bash
#SBATCH --job-name=hmamba_L_N1
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/hmamba_L_N1-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/hmamba_L_N1-%j.err
...
echo "============================================================"
echo "H-Mamba Large N1 — 2x A6000, general"
echo "============================================================"
...
torchrun --nproc_per_node=2 --master_port=$MASTER_PORT train_s2s_hmamba.py hparams/S2S/hmamba_large_N1.yaml \
    --data_folder /data/user_data/anshulk/hnet_asr/LibriSpeech \
    --output_folder /data/user_data/anshulk/hnet_asr/results/hmamba_large_N1 \
    --batch_size 16 \
...
if [ $TRAIN_EXIT -eq 0 ]; then
    ...
    python train_s2s_hmamba.py hparams/S2S/hmamba_large_N1.yaml \
        --data_folder /data/user_data/anshulk/hnet_asr/LibriSpeech \
        --output_folder /data/user_data/anshulk/hnet_asr/results/hmamba_large_N1 \
        --batch_size 16 \
        --max_batch_length_train 600 \
