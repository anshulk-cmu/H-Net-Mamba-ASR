#!/bin/bash
#SBATCH --job-name=conmambamamba_S_S2S
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/conmambamamba_S_S2S-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/conmambamamba_S_S2S-%j.err
...
echo "============================================================"
echo "conmambamamba_small S2S — 2x A6000, preempt"
echo "============================================================"
