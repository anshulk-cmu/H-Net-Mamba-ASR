#!/bin/bash
#SBATCH --job-name=hmamba_S_N1
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/hmamba_S_N1-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/hmamba_S_N1-%j.err
...
echo "============================================================"
echo "H-Mamba Small N1 — 2x A6000, preempt"
echo "============================================================"
...
torchrun --nproc_per_node=2 --master_port=$MASTER_PORT train_s2s_hmamba.py hparams/S2S/hmamba_small_N1.yaml \
