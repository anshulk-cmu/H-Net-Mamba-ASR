#!/bin/bash
#SBATCH --job-name=eval_conmamba_S_nolm
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/eval_conmamba_S_nolm-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/eval_conmamba_S_nolm-%j.err
...
echo "============================================================"
echo "conmamba_small S2S — eval without LM — 2x A6000"
echo "============================================================"
