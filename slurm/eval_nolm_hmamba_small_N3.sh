#!/bin/bash
#SBATCH --job-name=eval_hmamba_S_N3_nolm
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/eval_hmamba_S_N3_nolm-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/eval_hmamba_S_N3_nolm-%j.err
...
echo "============================================================"
echo "H-Mamba Small N3 — eval without LM — 1x A6000"
echo "============================================================"
