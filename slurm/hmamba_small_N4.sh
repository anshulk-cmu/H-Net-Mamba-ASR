#!/bin/bash
#SBATCH --job-name=hmamba_S_N4
#SBATCH --output=/home/anshulk/h-mamba_asr/logs/hmamba_S_N4-%j.out
#SBATCH --error=/home/anshulk/h-mamba_asr/logs/hmamba_S_N4-%j.err
...
echo "============================================================"
echo "H-Mamba Small N4 — 2x A6000, preempt"
echo "============================================================"
...
torchrun --nproc_per_node=2 --master_port=$MASTER_PORT train_s2s_hmamba.py hparams/S2S/hmamba_small_N4.yaml \
