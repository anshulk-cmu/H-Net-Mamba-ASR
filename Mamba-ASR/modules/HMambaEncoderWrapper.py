...
class HMambaEncoderWrapper(nn.Module):
    ...
    def forward(
        ...
        # Match HMambaEncoder formulation: expanded_states * STE(selected_probs) + residual
        # STE allows gradients from ASR loss to flow through boundary decisions
        # residual_proj is zero-initialized so training starts as identity on expanded_states
